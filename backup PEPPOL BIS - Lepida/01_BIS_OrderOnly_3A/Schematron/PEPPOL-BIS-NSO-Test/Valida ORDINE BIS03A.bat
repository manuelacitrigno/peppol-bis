@echo off
cls
echo PEPPOL BIS 03a v3.0 UBL-Order-2.1 two-phase validation
set "xml="
call _fc xml
...
call _w3cschema xsd\maindoc\UBL-Order-2.1.xsd "%xml%" >output\syntax_report.txt
...
call _xslt2 "%xml%" xsl\PEPPOL\ITNAT-UBL-T01-BIS03A.xsl output\svrl_report.xml

...
<pattern id="INT-UBL-T16" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="//cbc:EndpointID" flag="fatal">
		<assert test="(@schemeID='9921' and matches(.,'^[a-zA-Z0-9]{6,7}$')) or @schemeID!='9921'" flag="fatal" id="INT-T16-R026">[INT-T16-R026] - Se l'identificatore di endpoint si basa sullo schema di identificatori IT:IPA (ICD: 9921), questo dovrà seguire la sintassi [A-Z0-9]{6,7}.</assert>

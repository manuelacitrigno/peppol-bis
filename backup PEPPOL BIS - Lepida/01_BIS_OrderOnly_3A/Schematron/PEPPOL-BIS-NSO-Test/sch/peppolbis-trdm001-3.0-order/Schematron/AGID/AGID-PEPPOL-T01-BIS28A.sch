...
<pattern id="INT-UBL-T01" xmlns="http://purl.oclc.org/dsdl/schematron">
	...
	<rule context="/ubl:Order"> 
		<assert test="cbc:CustomizationID = 'urn:fdc:peppol.eu:poacc:trns:order_response:3:extended:urn:www.ubl-italia.org:spec:ordine:ver3.1' and cbc:ProfileID = 'urn:fdc:peppol.eu:poacc:bis:ordering:3'" flag="fatal" id="INT-T01-R003">[INT-T01-R003] - La transazione dell'Ordine DEVE essere identificata dai seguenti identificativi: 

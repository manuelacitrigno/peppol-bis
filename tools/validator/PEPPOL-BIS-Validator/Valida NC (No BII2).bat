@echo off
cls
echo PEPPOL BIS 05a v2.0 UBL-CreditNote-2.1 two-phase validation
set "xml="
call _fc xml
...
call _w3cschema xsd\maindoc\UBL-CreditNote-2.1.xsd "%xml%" >output\syntax_report.txt
...
call _xslt2 "%xml%" xsl\PEPPOL\ITNAT-UBL-T14_NOBII2.xsl output\svrl_report.xml

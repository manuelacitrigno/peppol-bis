@echo off
cls
echo Fattura-PA-1.2-to-PEPPOL-BIS-05a-400_UBL-CreditNote-2.1_NoTIER conversion
set "xml="
call _fc xml
...
call _xslt2 "%xml%" adapters\government\it\Fattura-PA-1.2-to-PEPPOL-BIS-05a-400_UBL-CreditNote-2.1_NoTIER\adapter.xsl output\converted.xml 2>output\conversion_report.txt
